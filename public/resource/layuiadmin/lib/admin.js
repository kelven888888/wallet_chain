    ...
    function(e) {
        var a = layui.jquery,
            ...
            P = {
                ...
                sendAuthCode: function(e) {
                    ...
                    var t, i = e.seconds,
                        ...
                        l = function(a) {
                            i--,
                                i < 0 ? (n.removeClass(f).html("获取验证码"), i = e.seconds, clearInterval(t)) : n.addClass(f).html(i + "秒后重获"),
                        ...
                        n.on("click",
                            function() {
                                ...
                                if (i === e.seconds && !a(this).hasClass(f)) {
                                    if (!/^1\d{10}$/.test(n)) return t.focus(),
                                        layer.msg("请输入正确的手机号");
                ...
                sideFlexible: function(e) {
                    var t = u,
                        i = a("#" + h),
                        l = P.screen();
                    "spread" === e ? (i.removeClass(x).addClass(g), l < 2 ? t.addClass(v) : t.removeClass(v), t.removeClass(C)) : (i.removeClass(g).addClass(x), l < 2 ? t.removeClass(C) : t.addClass(C), t.removeClass(v)),
                ...
                resize: function(e) {
                    var a = layui.router(),
                        t = a.path.join("-");
                    P.resizeFn[t] && (r.off("resize", P.resizeFn[t]), delete P.resizeFn[t]),
                    "off" !== e && (e(), P.resizeFn[t] = e, r.on("resize", P.resizeFn[t]))
                },
                resizeFn: {},
                runResize: function() {
                    var e = layui.router(),
            ...
            F = P.events = {
                ...
                rollPage: function(e, t) {
                    ...
                    if ("left" === e) {
                            ...
                            if (r[0]) {
                                ...
                                if (e + r.outerWidth() >= l - s) {
                                    ...
                                    n.each(function(e, t) {
                                        var n = a(t),
                                            l = n.position().left;
                                        if (l + s > 0 && l - s > o) return i.css("left", -l),
                                            !1
                                    })
                                }
                            }
                        ...
                        var n = a(t),
                            r = n.position().left;
                        if (r + n.outerWidth() >= l - s) return i.css("left", -r),
                            !1
                    })
                },
                leftPage: function() {
            ...
            i.on("tab(" + p + ")",
              ...
              //      a.cookie('tabpage', e.index);
              // src=P.tabsBody(P.tabsPage.index).find("iframe").attr("src");
              // console.log(src)
              //       console.log(src)
              //       console.log(src)
              //       console.log(e.index)
        ...
        o.on("click", _,
            ...
            o.on("click", "*[lay-href]",
                function() {
                    ...
                    n.index.openTabsPage(t, i || e.text()),
                    t === P.tabsBody(P.tabsPage.index).find("iframe").attr("src") && P.events.refresh()
                }),
