...
// Getinfo  获取钱包信息
func (as Service) Getinfo() utils.Info {
...
func (as Service) ValidateAddress(addr string) utils.ValidateAddress {
	var resp utils.ValidateAddress
...
//zenrpc:skip=0
//zenrpc:addr="*"
func (as Service) ListTransactions(addr string, count, skip int) ([]utils.Transactions, error) {
...
func (as Service) GetRecords(sTime, eTime int64) ([]utils.SummaryData, error) {
